...
contacts = generate.build_contacts(ligand_selection="resname POPE POPG CARD", protein_selection="protein",frameskip=1,cutoff=6,KDTree=True)
...
data.to_dataframe().to_csv("#PROT#.csv")
